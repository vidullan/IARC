...
class Window(tk.Tk):
    ...
    def cycle_frames(self, container, desired_state):
        ...
        #for _frame in (command_page):

        page_name = command_page.__name__
        frame = command_page(desired_state, parent = container, controller = self)
        self.frames[page_name] = frame
        frame.grid(row=0, column=0, sticky="nsew")

        self.show_frame("command_page")
